...
import { deposit, payLoan, requestLoan, withdraw } from "./account.slice";
...
function AccountOperations() {
  ...
  const { loan: currentLoan, loanPurpose: currentLoanPurpose, isLoading } = useSelector((state: RootState) => state.account)
